...
menu.innerHTML=`
  ...
  <button onclick="bukaIframe('http://34.170.37.50:8080/NURgenerator/meta/video-drive.html')" style="padding:9px 8px;background:#7f1d1d;color:#fff;border:1px solid #f00;border-radius:8px;text-align:left;font-weight:700;font-size:11px;cursor:pointer;transition:all 0.2s;width:100%;">🎬 VIDEO DRIVE (ALWI Tube)</button>
