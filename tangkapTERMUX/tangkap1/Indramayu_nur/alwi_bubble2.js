...
menu.innerHTML=`
  ...
  <button onclick="bukaIframe('http://35.240.161.189:3000')" style="padding:9px 8px;background:#0284c7;color:#fff;border:1px solid #38bdf8;border-radius:8px;text-align:left;font-weight:700;font-size:11px;cursor:pointer;transition:all 0.2s;width:100%;">
🤖 TANYA ALWI (Chat AI)</button>
...
(function(){
  ...
  function pasangFolder(){
    ...
    var F=[
      ...
      ['peta','\uD83D\uDDFA\uFE0F PETA & NASA'],
      ['mmeta/template-komentar.html','\u2699\uFE0F tulis di sini']
    ];
